...
fName = 'data/nzcontmatrix.xlsx';
fprintf('   Loading contact matrix:    %s\n', fName)
C = readmatrix(fName); % Get Prem et al contact matrix from data folder

fName = 'data/nzpopdist.xlsx';      % This should *ALWAYS* be the national population distribution 'nzpopdist.xlsx'
fprintf('   Loading benchmark population distribution for contact matrix:    %s\n', fName)
tmp = readmatrix(fName); % Load NZ population structure from data folder
